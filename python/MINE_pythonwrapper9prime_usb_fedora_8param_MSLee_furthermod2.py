import sys
sys.path.insert(0, '/home/namu_2nd_samsung/.local/lib/python3.12/site-packages/classy-3.2.1-py3.12-linux-x86_64.egg/classy.cpython-312-x86_64-linux-gnu.so')
...
Omega_Lambda3 = np.arange(-0.020, -0.013, 0.001)
h_range = np.arange(0.68, 0.72, 0.01)
omega_b_range = np.arange(0.0217, 0.0224, 0.0002)
omega_cdm_range = np.arange(0.116, 0.122, 0.002)
A_s_range = np.arange(2.08e-09, 2.13e-09, 0.01e-09)
n_s_range = np.arange(0.960, 0.978, 0.002)
tau_reio_range = np.arange(0.053, 0.057, 0.001)
