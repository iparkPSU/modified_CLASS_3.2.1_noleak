...
h_range = np.arange(0.65, 0.755, 0.005)
omega_b_range = np.arange(0.0215, 0.0235, 0.0001)
omega_cdm_range = np.arange(0.1100, 0.1400, 0.004)
A_s_range = np.arange(2.0000549e-09, 2.2000549e-09, 0.05e-09)
n_s_range = np.arange(0.95, 0.99, 0.01)
tau_reio_range = np.arange(0.052, 0.056, 0.001)
